...
<?php
$pageTitle = 'Retrait client';
$pageSubtitle = 'Retrait avec frais selon l’intervalle';
...
<div class="card" style="max-width: 720px; margin: 0 auto;">
    <div class="card-header">
        <div>
            ...
            <p>Le numéro saisi reçoit le montant retiré, et le frais est calculé selon la tranche correspondante.</p>
        </div>
    </div>
    <div class="card-body">
        <form action="/mouvement/retrait" method="post" class="form-grid">
            <div class="field">
